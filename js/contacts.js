...
const tooltipHints = {
    sr: {
        ...
        'fg-email': { title: 'Email adresa', body: 'Unesite valjanu email adresu u formatu: korisnik@domen.com' },
    ...
    en: {
        ...
        'fg-email': { title: 'Email Address', body: 'Enter a valid email address in the format: user@domain.com' },
...
function submitContact() {
    ...
    if (!v1 || !v2 || !v3 || !v4) {
        const firstError = document.querySelector('.is-invalid .form-field-input');
